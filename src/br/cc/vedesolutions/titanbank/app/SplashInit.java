package br.cc.vedesolutions.titanbank.app;

import java.io.IOException;

import br.cc.vedesolutions.titanbank.ui.controllers.SplashScreenController;
...
//metodo que faz chamada a SplashScreen (tela de inicializacao)
...
public class SplashInit extends Preloader {
	...
	private Scene createPreloaderScene() throws IOException {
		FXMLLoader fxmlloader = new FXMLLoader(
				getClass().getClassLoader().getResource("./br/cc/vedesolutions/titanbank/ui/views/SplashScreen.fxml"));
