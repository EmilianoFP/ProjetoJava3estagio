...
public class AdmUserInforScreenController implements Initializable {
	...
	private boolean isInputValid() {
		...
		if (errorMessage.length() == 0){
			...
			md.setDigloaHeader("Por favorm corrija os campos invalidos");
