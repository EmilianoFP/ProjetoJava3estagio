...
public class UserScreenTransferenciaController implements Initializable, IControlledScreen {
	...
	void btnVoltarOnAction(ActionEvent event) {
		...
		this.myController.loadScreen("user_logged", "./br/cc/vedesolutions/titanbank/ui/views/UserPrincipalScreen.fxml");
	...
	private void chamarTelaSenha(Cliente cl, double valor) {
		//this.myController.loadScreen("user_senha", "./br/cc/vedesolutions/titanbank/ui/views/UserSenhaScreen.fxml");
		try {
			FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("./br/cc/vedesolutions/titanbank/ui/views/UserSenhaScreen.fxml"));
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if (GlobalInfor.cliente_logged != null) {
			...
			this.lbContaTipoNome
					.setText(GlobalInfor.cliente_logged.isTipoConta() == true ? "Conta corrente" : "Conta poupanca");
		} else {
