...
public abstract class Hash {
	...
	/**
	 * @brief Metodo para converter um array de bytes em uma String hexadecimal.
	 * @param array de bytes com os valores.
	 * @param mask String com o tipo de mascara.
	 * @see "%02X" ou %C.
	...
	/**
	 * @brief Metodo para converter um caractere char em um nibble hexadecimal.
	...
	/**
	 * @brief Metodo para codificar uma string com o algoritmo Base64.
	 * @param input String a ser codificada.
	 * @return O retorno sera a String codificada.
	 */
	...
	/**
	 * @brief Metodo para decodificar uma string com o algoritmo Base64.
	 * @param input String a ser decodificada.
	 * @return O retorno sera a String decodificada.
	 */
